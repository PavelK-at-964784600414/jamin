  ...
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      ...
      <div className="rounded-xl bg-gray-700 p-4">
        <div className="mt-0 grid h-[410px] grid-cols-12 items-end gap-2 rounded-md bg-gray-800 p-4 sm:grid-cols-13 md:gap-4" />
...
export function LatestThemesSkeleton() {
  return (
    <div
    ...
    <tr className="w-full border-b border-gray-700 last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      ...
      <td className="whitespace-nowrap py-3 pl-6 pr-3">
        <div className="flex justify-end gap-3">
          <div className="h-[38px] w-[38px] rounded bg-gray-600"></div>
          <div className="h-[38px] w-[38px] rounded bg-gray-600"></div>
        </div>
      </td>
    </tr>
...
export function ThemesMobileSkeleton() {
  return (
    <div className="mb-2 w-full rounded-md bg-gray-800 p-4">
      ...
      <div className="flex w-full items-center justify-between pt-4">
        <div>
          <div className="h-6 w-16 rounded bg-gray-600"></div>
          <div className="mt-2 h-6 w-24 rounded bg-gray-600"></div>
        </div>
